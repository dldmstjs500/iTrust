...
<div align=center>
	<div style="margin-right: 10px;">
		<table class="fTable" align="center">
			...
			<%if(patient.getActivated()==0){%>
			<tr>
				<td class="subHeaderVertical">Height:</td>
				<td ><%= StringEscapeUtils.escapeHtml("" + (patient.getHeight())) %></td>
			</tr>
			<tr>
				<td class="subHeaderVertical">Weight:</td>
				<td ><%= StringEscapeUtils.escapeHtml("" + (patient.getWeight())) %></td>
			</tr>
			<tr>
				<td class="subHeaderVertical">Smoker?:</td>
				<td ><%= StringEscapeUtils.escapeHtml("" + (patient.getSmoker())) %></td>
			</tr>
			<%}%>
		</table>
		<br />
	...
	<div style="margin-right: 10px;">
		...
		<br />
		<% if (!(null == mostRecent && patient.getActivated()==0)){%>
