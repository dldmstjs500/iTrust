	...
	<tr>
		...
		<table class="fTable" align=center style="width: 350px;">
			...
			<tr>
				...
				<td ><input name="height" value="<%= StringEscapeUtils.escapeHtml("" + (p.getHeight())) %>" type="text"></td>
			</tr>
			<tr>
				<td class="subHeaderVertical">Weight:</td>
				<td ><input name="weight" value="<%= StringEscapeUtils.escapeHtml("" + (p.getWeight())) %>" type="text"></td>
			</tr>
			<tr>
				<td class="subHeaderVertical">Smoker:</td>
				<td ><input name="smoker" value="<%= StringEscapeUtils.escapeHtml("" + (p.getSmoker())) %>" type="text"></td>
			</tr>
			<%}%>
		</table>
		<br />
