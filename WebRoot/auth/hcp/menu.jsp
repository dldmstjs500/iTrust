<div class="panel panel-default">
	...
	<div class="panel-body" id="info-menu">
		<ul class="nav nav-sidebar">
			...
			<li><a href="/iTrust/auth/hcp-uap/viewPreRegisteredPatientList.jsp">Pre-registered Patients</a>
			...
			<li><a href="/iTrust/auth/hcp-cod/viewCauseOfDeathReport.jsp">Cause of Death Report</a>
