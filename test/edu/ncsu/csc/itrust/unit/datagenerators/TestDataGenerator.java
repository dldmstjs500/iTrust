...
public class TestDataGenerator {
	...
	public void uc14s3() throws  SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/uc14s3.sql");
	}
	...
	public void preRegisteredPatientData() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/preRegisteredPatientData.sql");
	}
