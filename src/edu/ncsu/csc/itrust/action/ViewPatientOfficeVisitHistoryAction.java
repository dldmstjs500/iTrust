 ...
 */
	...
	public List<PatientBean> getPreRegisteredPatients() throws DBException {
		...
		patients = patientDAO.getPreRegisteredPatients();
		return patients;
	}

	public void registerPatient(PatientBean p) throws FormValidationException, ITrustException {
		p.setActivated(1);
		patientDAO.editPatient(p, loggedInMID);
	}

	public void deregisterPatient(PatientBean p) throws FormValidationException, ITrustException {
		patientDAO.removePatient(p.getMID());
	}
}