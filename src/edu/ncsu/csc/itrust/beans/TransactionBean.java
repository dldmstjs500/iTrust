...
public class TransactionBean {
	...
	private String role;
	/* added private logged-in role element */
	private String loggedInRole;
	/* added private secondary role element */
	...
	/**
	 * Getter for loggedInRole
	 * @return String stored in loggedInRole
	 */
	...
	/**
	 * Setter for loggedInRole
	 * @param role String role name to be stored in loggedInRole
	 */
	...
	/**
	 * Getter for secondaryRole
	 * @return String stored in secondaryRole
	 */
	...
	/**
	 * Setter for secondaryRole
	 * @param role String role name to be stored in secondaryRole
	 */
	public void setSecondaryRole(String role){
